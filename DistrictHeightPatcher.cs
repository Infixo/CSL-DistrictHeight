...
namespace DistrictHeight
{
    ...
    public static class PrivateBuildingAI_Patches
    {
        ...
        public static bool PrivateBuildingAI_GetUpgradeInfo_Prefix(PrivateBuildingAI __instance, ref BuildingInfo __result, ushort buildingID, ref Building data)
        {
            ...
            buildingInfo = Singleton<BuildingManager>.instance.GetRandomBuildingInfoDis(ref Singleton<SimulationManager>.instance.m_randomizer, service, subService, level, num26, num25, zoningMode3, style, district);
            // Call privatebuildingai
            */
            return false;
        }
    }
